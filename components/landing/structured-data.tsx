export function StructuredData() {
  const organizationSchema = {
    ...
    "description": "From sourcing to shelf – fully managed. Flexible 3PL, fulfillment & global logistics solutions for retail, FMCG and e-commerce.",
    "address": {
      "@type": "PostalAddress",
    ...
    "sameAs": [
      "https://www.linkedin.com/company/sacalogistics"
    ]
  }
      ...
      "itemListElement": [
        {
          ...
          "itemOffered": {
            ...
            "description": "Structured warehouse operations designed for accuracy, reliability and scalability."
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            ...
            "description": "Comprehensive B2B & B2C order processing for e-commerce and omnichannel businesses."
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            ...
            "description": "Rapidly scale operational capacity with trained and certified staff."
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            ...
            "description": "Labelling, kitting, co-packing, and product preparation services."
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            ...
            "description": "International freight coordination and customs management."
          }
        }
      ]
    }
